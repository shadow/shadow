...
enum _PacketDeliveryStatusFlags {
    ...
    PDS_RCV_INTERFACE_RECEIVED = 1 << 10,
    PDS_RCV_INTERFACE_DROPPED = 1 << 11,
    PDS_RCV_SOCKET_PROCESSED = 1 << 12,
    PDS_RCV_SOCKET_DROPPED = 1 << 13,
    PDS_RCV_TCP_ENQUEUE_UNORDERED = 1 << 14,
    PDS_RCV_SOCKET_BUFFERED = 1 << 15,
    PDS_RCV_SOCKET_DELIVERED = 1 << 16,
    PDS_DESTROYED = 1 << 17,
};
