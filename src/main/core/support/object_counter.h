...
enum _ObjectType {
    ...
    OBJECT_TYPE_ROUTER,
    OBJECT_TYPE_HOST,
    OBJECT_TYPE_NETIFACE,
    OBJECT_TYPE_PROCESS,
    OBJECT_TYPE_SYSCALL_CONDITION,
    OBJECT_TYPE_THREAD_PRELOAD,
    OBJECT_TYPE_THREAD_PTRACE,
    OBJECT_TYPE_SYSCALL_HANDLER,
    OBJECT_TYPE_DESCRIPTOR_LISTENER,
    OBJECT_TYPE_DESCRIPTOR_TABLE,
