    ...
    (@ $bytes:expr, $type:ty, $(($field:ident: $generic:ident)),*) => {{
        ...
        fn field_project<$( $generic: shadow_pod::Pod ),*>(
            ...
            Some(( $( {
                ...
                //   to must not get accessed (read or written) through any other pointer." - this
                //   function makes sure the returned reference has the correct lifetime
