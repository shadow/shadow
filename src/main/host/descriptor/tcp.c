...
static TCPServer* _tcpserver_new(gint backlog, const Process* processForChildren) {
...
void tcp_enterServerMode(TCP* tcp, const Host* host, const Process* process, gint backlog) {
    MAGIC_ASSERT(tcp);
