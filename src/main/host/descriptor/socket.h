...
typedef gssize (*SocketSendFunc)(LegacySocket* socket, ThreadRc* thread, PluginVirtualPtr buffer,
                                 gsize nBytes, in_addr_t ip, in_port_t port);
typedef gssize (*SocketReceiveFunc)(LegacySocket* socket, ThreadRc* thread, PluginVirtualPtr buffer,
                                    gsize nBytes, in_addr_t* ip, in_port_t* port);
...
gssize legacysocket_sendUserData(LegacySocket* socket, ThreadRc* thread, PluginVirtualPtr buffer,
                                 gsize nBytes, in_addr_t ip, in_port_t port);
gssize legacysocket_receiveUserData(LegacySocket* socket, ThreadRc* thread, PluginVirtualPtr buffer,
                                    gsize nBytes, in_addr_t* ip, in_port_t* port);
