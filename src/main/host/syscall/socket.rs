...
pub fn sendto(ctx: &mut ThreadContext, args: &SysCallArgs) -> SyscallResult {
    ...
    sendto_helper(ctx, socket, buf_ptr, buf_len, flags, addr_ptr, addr_len)
}
...
pub fn recvfrom(ctx: &mut ThreadContext, args: &SysCallArgs) -> SyscallResult {
    ...
    recvfrom_helper(ctx, socket, buf_ptr, buf_len, flags, addr_ptr, addr_len_ptr)
}
...
mod export {
    ...
    pub extern "C" fn rustsyscallhandler_sendto(
        ...
        let mut objs = unsafe { ThreadContextObjs::from_syscallhandler(notnull_mut_debug(sys)) };
        sendto(&mut objs.borrow(), unsafe { args.as_ref().unwrap() }).into()
    }
    ...
    pub extern "C" fn rustsyscallhandler_recvfrom(
        ...
        let mut objs = unsafe { ThreadContextObjs::from_syscallhandler(notnull_mut_debug(sys)) };
        recvfrom(&mut objs.borrow(), unsafe { args.as_ref().unwrap() }).into()
    }
    ...
    pub extern "C" fn rustsyscallhandler_getsockname(
        ...
        let mut objs = unsafe { ThreadContextObjs::from_syscallhandler(notnull_mut_debug(sys)) };
        getsockname(&mut objs.borrow(), unsafe { args.as_ref().unwrap() }).into()
    }
    ...
    pub extern "C" fn rustsyscallhandler_getpeername(
        ...
        let mut objs = unsafe { ThreadContextObjs::from_syscallhandler(notnull_mut_debug(sys)) };
        getpeername(&mut objs.borrow(), unsafe { args.as_ref().unwrap() }).into()
    }

    #[no_mangle]
    pub extern "C" fn rustsyscallhandler_socketpair(
        sys: *mut c::SysCallHandler,
        args: *const c::SysCallArgs,
    ) -> c::SysCallReturn {
        let mut objs = unsafe { ThreadContextObjs::from_syscallhandler(notnull_mut_debug(sys)) };
        socketpair(&mut objs.borrow(), unsafe { args.as_ref().unwrap() }).into()
    }
}
