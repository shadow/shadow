...
typedef int (*poll_func)(struct pollfd *pfd, nfds_t nfd, int timeout);
...
static void _interposer_globalInitialize() {
    ...
    SETSYM_OR_FAIL(director.next.eventfd, "sleep");
    SETSYM_OR_FAIL(director.next.eventfd, "nanosleep");
    SETSYM_OR_FAIL(director.next.eventfd, "usleep");
    SETSYM_OR_FAIL(director.next.eventfd, "select");
    SETSYM_OR_FAIL(director.next.eventfd, "poll");
    SETSYM_OR_FAIL(director.next.eventfd, "system");
    SETSYM_OR_FAIL(director.next.eventfd, "fork");
    SETSYM_OR_FAIL(director.next.eventfd, "sigwait");
    SETSYM_OR_FAIL(director.next.eventfd, "waitpid");
