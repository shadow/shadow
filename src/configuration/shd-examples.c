...
GString* example_getEchoExampleContents() {
	return g_string_new("<plugin name=\"echoplugin\" path=\"libshadow-plugin-echo.so\" /><cdf name=\"echocpu\" center=\"100000000\" width=\"20000000\" tail=\"20000000\" /><cdf name=\"echobandwidth\" center=\"10\" width=\"0\" tail=\"0\" /><cdf name=\"echolatency\" center=\"200\" width=\"40\" tail=\"20\" /><network name=\"echonetwork\" latency=\"echolatency\" reliability=\"1.0\" /><network name=\"echonetwork2\" latency=\"echolatency\" reliability=\"0.5\" /><software name=\"echoudpserver\" plugin=\"echoplugin\" time=\"10\" arguments=\"server udp\" /><software name=\"echotcpserver\" plugin=\"echoplugin\" time=\"10\" arguments=\"server tcp\" /><software name=\"echoudpclient\" plugin=\"echoplugin\" time=\"20\" arguments=\"client udp udpserver.echo\" /><software name=\"echotcpclient\" plugin=\"echoplugin\" time=\"20\" arguments=\"client tcp tcpserver.echo\" /><software name=\"echoudploopback\" plugin=\"echoplugin\" time=\"20\" arguments=\"loopback udp\" /><software name=\"echotcploopback\" plugin=\"echoplugin\" time=\"20\" arguments=\"loopback tcp\" /><node name=\"udpserver.echo\" software=\"echoudpserver\" network=\"echonetwork\" bandwidthup=\"echobandwidth\" bandwidthdown=\"echobandwidth\" cpu=\"echocpu\" /><node name=\"udpclient.echo\" software=\"echoudpclient\" network=\"echonetwork\" bandwidthup=\"echobandwidth\" bandwidthdown=\"echobandwidth\" cpu=\"echocpu\" /><node name=\"udploopback.echo\" software=\"echoudploopback\" network=\"echonetwork\" bandwidthup=\"echobandwidth\" bandwidthdown=\"echobandwidth\" cpu=\"echocpu\" /><node name=\"tcpserver.echo\" software=\"echotcpserver\" network=\"echonetwork2\" bandwidthup=\"echobandwidth\" bandwidthdown=\"echobandwidth\" cpu=\"echocpu\" /><node name=\"tcpclient.echo\" software=\"echotcpclient\" network=\"echonetwork2\" bandwidthup=\"echobandwidth\" bandwidthdown=\"echobandwidth\" cpu=\"echocpu\" /><node name=\"tcploopback.echo\" software=\"echotcploopback\" network=\"echonetwork2\" bandwidthup=\"echobandwidth\" bandwidthdown=\"echobandwidth\" cpu=\"echocpu\" /><kill time=\"180\" />");
}
