...
extern uint8_t global_processed_cells[8];
...
extern uint8_t nexttimetorecord[8];
...
extern uint8_t stats_n_cert_cells_processed[8];
...
extern uint8_t has_validated_pt[4];
