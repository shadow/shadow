...
pub type CpuidResult = core::arch::x86_64::CpuidResult;
...
pub fn cpuid(leaf: u32, sub_leaf: Option<u32>) -> CpuidResult {
    match sub_leaf {
        // SAFETY: Unclear why these are marked unsafe in `core`;
        // the cpuid instruction doesn't have any unsafe side effects.
        // Probably just a knee-jerk precaution around raw asm blocks.
