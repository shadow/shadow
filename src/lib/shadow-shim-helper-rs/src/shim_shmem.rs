        ...
        Self {
            ...
            protected: RootedRefCell::new(
                ...
                ProcessShmemProtected {
                    ...
                    // SAFETY: any bit pattern is a sound value of `shd_kernel_sigaction`.
                    // TODO: Move the Pod trait out of shadow and use it here.
                    signal_actions: [unsafe { std::mem::zeroed() }; SHD_SIGRT_MAX as usize],
                },
            ),
        }
    }
...
mod export {
    ...
    pub enum ShimShmemHost {}
    impl ShimShmemHost {
        fn to_rs(h: *const Self) -> *const HostShmem {
            h as *const _
        }
        fn to_rs_mut(h: *mut Self) -> *mut HostShmem {
            h as *mut _
        }
        #[allow(unused)]
        fn from_rs(h: *const HostShmem) -> *const Self {
            h as *const _
        }
        #[allow(unused)]
        fn from_rs_mut(h: *mut HostShmem) -> *mut Self {
            h as *mut _
        }
    }

    pub enum ShimShmemHostLock {}
    impl ShimShmemHostLock {
        fn to_rs(h: *const Self) -> *const HostShmemProtected {
            h as *const _
        }
        fn to_rs_mut(h: *mut Self) -> *mut HostShmemProtected {
            h as *mut _
        }
        #[allow(unused)]
        fn from_rs(h: *const HostShmemProtected) -> *const Self {
            h as *const _
        }
        #[allow(unused)]
        fn from_rs_mut(h: *mut HostShmemProtected) -> *mut Self {
            h as *mut _
        }
    }
    ...
    pub unsafe extern "C" fn shimshmemhost_init(
        ...
        let host_mem = ShimShmemHost::to_rs_mut(host_mem);
    ...
    pub unsafe extern "C" fn shimshmemhost_lock(
        ...
        let host = unsafe { ShimShmemHost::to_rs(host).as_ref().unwrap() };
        let mut guard = host.protected().lock();
        let lock = ShimShmemHostLock::from_rs_mut(&mut *guard);
        guard.disconnect();
        lock
    }
    ...
    pub enum ShimShmemProcess {}
    impl ShimShmemProcess {
        fn to_rs(h: *const Self) -> *const ProcessShmem {
            h as *const _
        }
        fn to_rs_mut(h: *mut Self) -> *mut ProcessShmem {
            h as *mut _
        }
        #[allow(unused)]
        fn from_rs(h: *const ProcessShmem) -> *const Self {
            h as *const _
        }
        #[allow(unused)]
        fn from_rs_mut(h: *mut ProcessShmem) -> *mut Self {
            h as *mut _
        }
    }
    ...
    pub unsafe extern "C" fn shimshmemprocess_init(
        ...
        let lock = unsafe { ShimShmemHostLock::to_rs(lock).as_ref().unwrap() };
        let m = ProcessShmem::new(&lock.root, lock.host_id);
        assert_shmem_safe!(ProcessShmem, _test_process_shmem);
        unsafe { ShimShmemProcess::to_rs_mut(process_mem).write(m) }
    }
    ...
    pub unsafe extern "C" fn shimshmem_getEmulatedTime(
        ...
        let host_mem = unsafe { ShimShmemHost::to_rs(host_mem).as_ref().unwrap() };
    ...
    pub unsafe extern "C" fn shimshmem_getMaxRunaheadTime(
        ...
        let host_mem = unsafe { ShimShmemHostLock::to_rs(host_mem).as_ref().unwrap() };
    ...
    pub unsafe extern "C" fn shimshmem_setMaxRunaheadTime(
        ...
        let host_mem = unsafe { ShimShmemHostLock::to_rs_mut(host_mem).as_mut().unwrap() };
    ...
    pub unsafe extern "C" fn shimshmem_getProcessPendingSignals(
        ...
        let process_mem = unsafe { ShimShmemProcess::to_rs(process).as_ref().unwrap() };
        let lock = unsafe { ShimShmemHostLock::to_rs(lock).as_ref().unwrap() };
    ...
    pub enum ShimShmemThread {}
    impl ShimShmemThread {
        fn to_rs(h: *const Self) -> *const ThreadShmem {
            h as *const _
        }
        fn to_rs_mut(h: *mut Self) -> *mut ThreadShmem {
            h as *mut _
        }
        #[allow(unused)]
        fn from_rs(h: *const ThreadShmem) -> *const Self {
            h as *const _
        }
        #[allow(unused)]
        fn from_rs_mut(h: *mut ThreadShmem) -> *mut Self {
            h as *mut _
        }
    }
    ...
    pub unsafe extern "C" fn shimshmemthread_init(
        ...
        unsafe { ShimShmemThread::to_rs_mut(thread_mem).write(t) }
    }
    ...
    pub unsafe extern "C" fn shimshmem_getThreadPendingSignals(
        ...
        let thread_mem = unsafe { ShimShmemThread::to_rs(thread).as_ref().unwrap() };
        let lock = unsafe { ShimShmemHostLock::to_rs(lock).as_ref().unwrap() };
    ...
    pub unsafe extern "C" fn shimshmem_takePendingUnblockedSignal(
        ...
        let thread = unsafe { ShimShmemThread::to_rs(thread).as_ref().unwrap() };
        let lock = unsafe { ShimShmemHostLock::to_rs(lock).as_ref().unwrap() };
        ...
        let res = {
            if let Some(r) = thread_protected.take_pending_unblocked_signal() {
                ...
                let process = unsafe { ShimShmemProcess::to_rs(process).as_ref().unwrap() };
    ...
    pub unsafe extern "C" fn shimshmem_incrementUnappliedCpuLatency(
        ...
        let lock = unsafe { ShimShmemHostLock::to_rs_mut(lock).as_mut().unwrap() };
