...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of linux_rseq"][::core::mem::size_of::<linux_rseq>() - 32usize];
    ...
    ["Offset of field: linux_rseq::end"][::core::mem::offset_of!(linux_rseq, end) - 28usize];
};
...
pub const LINUX___IFLA_GENEVE_MAX: linux__bindgen_ty_24 = 16;
