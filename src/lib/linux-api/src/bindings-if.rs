...
const _: () = {
    ...
    ["Offset of field: linux_sockaddr::lsa_family"][::core::mem::offset_of!(linux_sockaddr, lsa_family) - 0usize];
    ["Offset of field: linux_sockaddr::lsa_data"][::core::mem::offset_of!(linux_sockaddr, lsa_data) - 2usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of linux_sync_serial_settings"][::core::mem::size_of::<linux_sync_serial_settings>() - 12usize];
    ["Alignment of linux_sync_serial_settings"][::core::mem::align_of::<linux_sync_serial_settings>() - 4usize];
...
const _: () = {
    ...
    ["Offset of field: linux_fr_proto::t391"][::core::mem::offset_of!(linux_fr_proto, t391) - 0usize];
    ["Offset of field: linux_fr_proto::t392"][::core::mem::offset_of!(linux_fr_proto, t392) - 4usize];
    ["Offset of field: linux_fr_proto::n391"][::core::mem::offset_of!(linux_fr_proto, n391) - 8usize];
    ["Offset of field: linux_fr_proto::n392"][::core::mem::offset_of!(linux_fr_proto, n392) - 12usize];
    ["Offset of field: linux_fr_proto::n393"][::core::mem::offset_of!(linux_fr_proto, n393) - 16usize];
    ["Offset of field: linux_fr_proto::lmi"][::core::mem::offset_of!(linux_fr_proto, lmi) - 20usize];
    ["Offset of field: linux_fr_proto::dce"][::core::mem::offset_of!(linux_fr_proto, dce) - 22usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
const _: () = {
    ...
    ["Offset of field: linux_fr_proto_pvc::dlci"][::core::mem::offset_of!(linux_fr_proto_pvc, dlci) - 0usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of linux_fr_proto_pvc_info"][::core::mem::size_of::<linux_fr_proto_pvc_info>() - 20usize];
    ["Alignment of linux_fr_proto_pvc_info"][::core::mem::align_of::<linux_fr_proto_pvc_info>() - 4usize];
...
const _: () = {
    ...
    ["Offset of field: linux_x25_hdlc_proto::dce"][::core::mem::offset_of!(linux_x25_hdlc_proto, dce) - 0usize];
    ...
    ["Offset of field: linux_x25_hdlc_proto::t1"][::core::mem::offset_of!(linux_x25_hdlc_proto, t1) - 12usize];
    ["Offset of field: linux_x25_hdlc_proto::t2"][::core::mem::offset_of!(linux_x25_hdlc_proto, t2) - 16usize];
    ["Offset of field: linux_x25_hdlc_proto::n2"][::core::mem::offset_of!(linux_x25_hdlc_proto, n2) - 20usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone, PartialEq, Eq)]
...
const _: () = {
    ...
    ["Offset of field: linux_ifmap::mem_start"][::core::mem::offset_of!(linux_ifmap, mem_start) - 0usize];
    ["Offset of field: linux_ifmap::mem_end"][::core::mem::offset_of!(linux_ifmap, mem_end) - 8usize];
    ["Offset of field: linux_ifmap::base_addr"][::core::mem::offset_of!(linux_ifmap, base_addr) - 16usize];
...
const _: () = {
    ...
    ["Offset of field: linux_if_settings::type_"][::core::mem::offset_of!(linux_if_settings, type_) - 0usize];
    ["Offset of field: linux_if_settings::size"][::core::mem::offset_of!(linux_if_settings, size) - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of linux_ifreq__bindgen_ty_1"][::core::mem::size_of::<linux_ifreq__bindgen_ty_1>() - 16usize];
    ["Alignment of linux_ifreq__bindgen_ty_1"][::core::mem::align_of::<linux_ifreq__bindgen_ty_1>() - 1usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of linux_ifreq__bindgen_ty_2"][::core::mem::size_of::<linux_ifreq__bindgen_ty_2>() - 24usize];
    ["Alignment of linux_ifreq__bindgen_ty_2"][::core::mem::align_of::<linux_ifreq__bindgen_ty_2>() - 8usize];
...
const _: () = {
    ...
    ["Offset of field: linux_ifreq::ifr_ifrn"][::core::mem::offset_of!(linux_ifreq, ifr_ifrn) - 0usize];
    ["Offset of field: linux_ifreq::ifr_ifru"][::core::mem::offset_of!(linux_ifreq, ifr_ifru) - 16usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of linux_ifconf__bindgen_ty_1"][::core::mem::size_of::<linux_ifconf__bindgen_ty_1>() - 8usize];
    ["Alignment of linux_ifconf__bindgen_ty_1"][::core::mem::align_of::<linux_ifconf__bindgen_ty_1>() - 8usize];
...
const _: () = {
    ...
    ["Offset of field: linux_ifconf::ifc_len"][::core::mem::offset_of!(linux_ifconf, ifc_len) - 0usize];
    ["Offset of field: linux_ifconf::ifc_ifcu"][::core::mem::offset_of!(linux_ifconf, ifc_ifcu) - 8usize];
};
