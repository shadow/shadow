...
```bash
sudo yum install -y gcc gcc-c++ python make cmake glib2 glib2-devel igraph igraph-devel xz xz-devel
...
```bash
sudo apt-get install -y gcc g++ python libglib2.0-0 libglib2.0-dev libigraph0v5 libigraph0-dev cmake make xz-utils
